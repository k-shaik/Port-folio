...
console.log("%cPassword: '123456' - I wonder what it does?🤔", "color: grey");
...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("visitor@khajashaik.com:~$", "no-animation", 0);
...
function commander(cmd) {
  switch (cmd) {
    ...
    case "projects":
      ...
      break;
    case "cert":
      loopLines(cert, "color2 margin", 80);
      break;
    case "contact":
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="mailto:khajashaik070404@gmail.com">khajashaik070404@gmail.com</a>...',
        "color2",
        80
      );
      newTab(email);
